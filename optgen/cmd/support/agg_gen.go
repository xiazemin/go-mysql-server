...
func (g *AggGen) Generate(defines GenDefs, w io.Writer) {
	...
	fmt.Fprintf(g.w, "    \"fmt\"\n")
	fmt.Fprintf(g.w, "    \"github.com/xiazemin/go-mysql-server/sql\"\n")
	fmt.Fprintf(g.w, "    \"github.com/xiazemin/go-mysql-server/sql/expression\"\n")
	fmt.Fprintf(g.w, "    \"github.com/xiazemin/go-mysql-server/sql/transform\"\n")
	fmt.Fprintf(g.w, ")\n\n")
